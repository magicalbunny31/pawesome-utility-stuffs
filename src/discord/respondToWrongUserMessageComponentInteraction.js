...
import { ContainerBuilder, heading, HeadingLevel, italic, inlineCode, quote, MessageFlags, subtext, SeparatorBuilder, SeparatorSpacingSize, TextDisplayBuilder } from "discord.js";
...
const getResponse = (emojis, expectedUser, receivedUser) => {
   const texts = [
      ...
      `${emojis.thinking} ${expectedUser} ≠ ${receivedUser}`,
      `${emojis.why} no, no, no!`,
      `${emojis.aie} huh?`,
 ...
 * @param {import("discord.js").User} expectedUser
 * @param {import("discord.js").User} receivedUser
 * @returns {Promise<void>}
 */
export default async (interaction, expectedUser, receivedUser) => {
